...
<head>
 ...
 <link href="../../css/student/StudentBindPage.css" rel="stylesheet" type="text/css"/>
</head>
...
<a href="/home" style="text-decoration:none"><img src="../../Img/exit.png">退出</a>
</div>
...
<div class="studentNum">学号:<input type="text" name="stuffNum"/></div>
